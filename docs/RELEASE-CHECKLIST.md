...
4. El proceso de publicación construye y comprueba la imagen para AMD64 y ARM64.
...
La publicación comienza únicamente al crear deliberadamente el tag estable.
...
La plantilla usa `stable`, que siempre señala la última versión comprobada.
