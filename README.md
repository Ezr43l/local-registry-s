...
<p align="center">
  ...
  <img alt="Versión v1.2.13" src="https://img.shields.io/badge/versión-v1.2.13-ff9f43">
...
en este repositorio es `v1.2.13`.
...
La plantilla descarga `ghcr.io/ezr43l/local-registry-s:v1.2.13`; no depende de un
...
La imagen pública se construye manualmente después de superar las pruebas en
un host Docker. Cada versión queda disponible con su etiqueta exacta y con el
alias `stable`. `docs/RELEASE-CHECKLIST.md` resume el proceso.
